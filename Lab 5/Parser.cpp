...
//For the last two functions, used parseCircleCommand as template and changed appropriately
...
Shape* parseTriangleCommand (stringstream &line) {
    ...
    float xcent = (x1 + x2 + x3)/3; //Finding x centre of triangle
    float ycent = (y1 + y2 + y3)/3; //Finding y centre of triangle
